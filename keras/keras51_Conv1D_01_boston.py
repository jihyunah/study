...
from tensorflow.keras.layers import Dense, Input, Dropout, Conv1D, Flatten, LSTM, MaxPooling2D  #함수형에는 인풋 레이어 해야함. 
import numpy as np
...
#================LSTM 모델에 적용하기 위해 3차원 데이터로 변환시켜줌===================#

x_train = x_train.reshape(404, 13, 1)
x_test = x_test.reshape(102, 13, 1)

print (x_train.shape, x_test.shape) # (404, 13, 1) (102, 13, 1) --> 3차원 데이터로 변환 완료
...
model = Sequential()
model.add(Conv1D(128, 2, input_shape=(13, 1), padding='same', activation='relu'))
...
# LSTM R2 :  0.690642098524174
# conv1d R2 :  0.8391082794315856