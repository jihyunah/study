...
dense3 = Dense(400, activation='relu')(drop2)
...
dense8 = Dense(90, activation='relu')(dense7)
dense9 = Dense(80, activation='relu')(dense8)
dense10 = Dense(70, activation='relu')(dense9)
dense11 = Dense(70, activation='relu')(dense10)
dense12 = Dense(70, activation='relu')(dense11)
dense13 = Dense(70, activation='relu')(dense12)
dense14 = Dense(60, activation='relu')(dense13)
dense15 = Dense(50, activation='relu')(dense14)
dense16 = Dense(30, activation='relu')(dense15)
dense17 = Dense(8, activation='relu')(dense16)
output1 = Dense(1, activation='linear')(dense17)
...
earlyStopping = EarlyStopping(monitor='val_loss', mode='min', patience=300, restore_best_weights=True, 
                              verbose=1)
