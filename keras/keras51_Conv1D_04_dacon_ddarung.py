...
test_csv = test_csv.reshape(715, 3, 3)  # 우리가 바꾼 모델에 맞춰서 하려면 쉐이프를 바꿔줘야 함. test x와 같은 것임. 

#2. 모델구성 (순차형)
model = Sequential()
model.add(Conv1D(128, 2, padding='same', input_shape=(3, 3), activation='relu'))
...
# LSTM R2: 0.6292142331076122
# conv1d R2: 0.6109768759456174