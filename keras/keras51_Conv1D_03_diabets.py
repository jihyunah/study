...
from tensorflow.python.keras.layers import Dense, Input, Dropout, Conv1D, Flatten, LSTM
import numpy as np
...
#2. 모델구성 (순차형)
model = Sequential()
model.add(Conv1D(128, 2, padding='same', input_shape=(5, 2), activation='relu'))
