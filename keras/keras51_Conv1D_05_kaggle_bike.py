...
from tensorflow.keras.layers import Dense, Input, Dropout, Conv1D, Flatten, LSTM
...
model = Sequential()
model.add(Conv1D(128, 2, padding='same', input_shape=(4, 2), activation='relu'))
...
# LSTM R2: 0.3017836676496771
# conv1d R2: 0.31159208774663294