...
#2. 모델 구성 (순차형)
model = Sequential()
model.add(Conv2D(128, (2,2), input_shape=(3, 3, 6), padding='same', activation='relu'))
...
model.summary() # Total params: 34,981
...
model.compile(loss='categorical_crossentropy', optimizer='adam', 
              metrics=['accuracy'])
earlyStopping = EarlyStopping(monitor='accuracy', mode='max', patience=10, restore_best_weights=True, 
                              verbose=1)
import datetime 
...
'''
minmax scaler:
accuracy score : 0.9375145220002926


standard scaler:
accuracy score : 0.9511200227188626

drop out
accucary: 0.8682994246482849

'''

# cnn accuracy score: 0.9294768637642746
